# RealTimeChatApp - Webapplikasjoner (ITF31619): Gruppe 21 
...
- Man kan logge inn på Demo Bruker og test meldingsfunksjonen med test bruker

- Etter man har gjort det, kan man logge ut av Demo, og deretter lage seg en ny bruker.

- Med en ny bruker kan du endre på dine preferanser på innstillinger
